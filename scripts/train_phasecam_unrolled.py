"""Train the physics-guided unrolled PhaseCam model."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the reduced PhaseCam unrolled model.")
...
def main() -> int:
    ...
    model = build_model("unrolled", config["model"], forward_model)
    ...
    best_model = load_checkpoint_model(checkpoint_dir / "best.pt", "unrolled", config["model"], forward_model, device)
